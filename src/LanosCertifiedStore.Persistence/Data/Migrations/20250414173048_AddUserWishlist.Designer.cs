...
namespace LanosCertifiedStore.Persistence.Data.Migrations
{
    ...
    [Migration("20250414173048_AddUserWishlist")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LanosCertifiedStore.Domain.Entities.UserRelated.UserWishlist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserWishlists", "identity");
                });
            ...
            modelBuilder.Entity("UserWishlistVehicle", b =>
                {
                    ...
                    b.HasKey("VehiclesId", "WishlistsId");

                    b.HasIndex("WishlistsId");

                    b.ToTable("VehiclesWishlists", "vehicles");
                });
            ...
            modelBuilder.Entity("LanosCertifiedStore.Domain.Entities.UserRelated.UserWishlist", b =>
                {
                    b.HasOne("LanosCertifiedStore.Domain.Entities.UserRelated.User", "User")
                        .WithOne("Wishlist")
                        .HasForeignKey("LanosCertifiedStore.Domain.Entities.UserRelated.UserWishlist", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UserWishlistVehicle", b =>
                {
                    b.HasOne("LanosCertifiedStore.Domain.Entities.VehicleRelated.Vehicle", null)
                        .WithMany()
                        .HasForeignKey("VehiclesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LanosCertifiedStore.Domain.Entities.UserRelated.UserWishlist", null)
                        .WithMany()
