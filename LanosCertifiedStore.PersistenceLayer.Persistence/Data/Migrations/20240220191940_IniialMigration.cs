    ...
    public partial class IniialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HexValue = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "UserDataModelUserRoleDataModel",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDataModelUserRoleDataModel", x => new { x.RolesId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_UserDataModelUserRoleDataModel_Roles_RolesId",
                        column: x => x.RolesId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserDataModelUserRoleDataModel_Users_UsersId",
                        column: x => x.UsersId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDataModelUserRoleDataModel_UsersId",
                table: "UserDataModelUserRoleDataModel",
                column: "UsersId");
