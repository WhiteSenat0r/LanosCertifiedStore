...
namespace Persistence.Data.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "VehicleTypesVehicleModels",
                columns: table => new
                {
                    AvailableTypesId = table.Column<Guid>(type: "uuid", nullable: false),
                    ModelsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleTypesVehicleModels", x => new { x.AvailableTypesId, x.ModelsId });
                    table.ForeignKey(
                        name: "FK_VehicleTypesVehicleModels_VehicleModels_ModelsId",
                        column: x => x.ModelsId,
                        principalTable: "VehicleModels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VehicleTypesVehicleModels_VehicleTypes_AvailableTypesId",
                        column: x => x.AvailableTypesId,
                        principalTable: "VehicleTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("55741291-bfef-447a-9681-5b7f5d90ec3e"), "Administrator" },
                    { new Guid("6ffc3d9c-24e1-43a9-b873-fcff43ea34cd"), "User" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleTypesVehicleModels_ModelsId",
                table: "VehicleTypesVehicleModels",
                column: "ModelsId");
        }
