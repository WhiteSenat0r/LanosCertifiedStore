...
// {
//     public CreateVehicleCommandValidator(IUnitOfWork unitOfWork, IValidationHelper inputValidationService)
//     {
//         RuleFor(x => x.Description)
//             .NotEmpty()
//             .MinimumLength(VehicleConstants.MinimalDescriptionLength)
//             .MaximumLength(VehicleConstants.MaximumDescriptionLength)
//             .WithMessage("Description must be greater than 20 characters and less than 3000!");
//
//         RuleFor(x => x.Price)
//             .NotEmpty()
//             .GreaterThan(VehicleConstants.MinimalPriceValue)
//             .WithMessage("Price must be greater than 0 $USD!");
//         
//         RuleFor(x => x.Displacement)
//             .NotEmpty()
//             .GreaterThan(VehicleConstants.MinimalDisplacementValue)
//             .WithMessage("Engine's displacement must be greater than 0 liters!");
//         
//         RuleFor(x => x.Mileage)
//             .NotEmpty()
//             .GreaterThanOrEqualTo(VehicleConstants.MinimalMileageValue)
//             .WithMessage("Mileage must be greater or equal to 0 km!");
//
//         RuleFor(x => x.ModelId)
//             .NotEmpty()
...
//             {
//                 var model = await unitOfWork.RetrieveRepository<VehicleModel>().GetEntityByIdAsync(data.ModelId);
//
//                 return model!.MinimalProductionYear <= data.ProductionYear &&
